...
<body>
  ...
  <section class="hero-wrap hero-wrap-2 ftco-degree-bg js-fullheight" style="background-image: url('images/giovany3.jpg');" data-stellar-background-ratio="0.5">
    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate pb-5 text-center">
          <div class="booking-form">
            <div class="tab-content">
              <div id="single">
                <h1 class='booking-header' style="color:black;">Find Your Next Home</h1>
                <form action="properties.php" method="post">
                  <div class="field-wrap" style="color:black;">
                  ...
                  <div class="field-wrap" style="color:black;">
                      <div class="dropdown" id="price">
                        <select style="border-color: black;" name="price" class="btn-dropdown-location" data-toggle="dropdown">
                          <option value="" disabled selected>Price</option>
                          <option value="p1">RM0-500</option>
                          <option value="p2">RM500-800</option>
                          <option value="p3">RM800-1000</option>
                          <option value="p4">RM100-1200</option>
                          <option value="p5">RM1200-1500</option>
                        </select>
                      </div>
                  </div>
        ...
        <div class="mouse">
          <a href="#" class="mouse-icon"> <!-- Click mouse button to slide down -->
  ...
  <section class="ftco-section goto-here"> <!-- mouse button connected using this line -->
    <section class="ftco-section ftco-no-pb">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
            <span class="subheading">Our Services</span>
            <h2 class="mb-2">The smartest way to find a new home</h2>
          </div>
        </div>
          ...
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body py-md-4">
                <h3>Reasonable</h3>
                <p>All rooms are priced RM1500 and below</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body py-md-4">
                ...
                <p>Find housing according to your budget</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body py-md-4">
                <h3>Apply for homes</h3>
                <p>Submit multiple applications</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body py-md-4">
                ...
                <p>Search for homes based on location you stay.</p>
              </div>
            </div>
          </div>
        </div>
...
<br>
      ...
      <section class="ftco-counter img" id="section-counter">
            ...
            <div class="col-md-6 col-lg-3 justify-content-center counter-wrap ftco-animate">
              <div class="block-18 py-4 mb-4">
                <div class="text text-border d-flex align-items-center">
                  ...
                  <span>Registered <br>Housing Officers</span>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-3 justify-content-center counter-wrap ftco-animate">
              <div class="block-18 py-4 mb-4">
                <div class="text d-flex align-items-center">
                  ...
                  <span>Applicants <br>Residing</span>
                </div>
              </div>
            </div>
          </div>
       ...
       <!-- Carousel is developed to create a place to view testimonies -->
        ...
        <div class="container">
          ...
          <div class="row ftco-animate">
            <div class="col-md-12">
              <div class="carousel-testimony owl-carousel ftco-owl">
                <div class="item">
                  <div class="testimony-wrap py-4">
                    <div class="text">
                      <p class="mb-4">I was able to find a home fast thanks to this system</p>
                      <div class="d-flex align-items-center">
                        <div class="user-img" style="background-image: url(images/t-3.jpeg)"></div>
                        <div class="pl-3">
                          <p class="name">Jibreel Mohamed</p>
                          <span class="position">Student, Segi University</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="item">
                  <div class="testimony-wrap py-4">
                    <div class="text">
                      <p class="mb-4">It is hard to walk around to find home, but this system is easy and saved transportation cost</p>
                      <div class="d-flex align-items-center">
                        <div class="user-img" style="background-image: url(images/t-2.jpeg)"></div>
                        <div class="pl-3">
                          <p class="name">Sharifah Zayadi</p>
                ...
                <div class="item">
                  <div class="testimony-wrap py-4">
                    <div class="text">
                      <p class="mb-4"> I was able to find a home within my budget and near my college </p>
                      <div class="d-flex align-items-center">
                        <div class="user-img" style="background-image: url(images/t-4.jpeg)"></div>
                        <div class="pl-3">
                          <p class="name">Malini Shankar</p>
                          <span class="position">CITY University</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="testimony-wrap py-4">
                <div class="text">
                  <p class="mb-4">The process is much faster and cheaper compared to traditional house hunting.</p>
                  <div class="d-flex align-items-center">
                    <div class="user-img" style="background-image: url(images/person_1.jpg)"></div>
                    <div class="pl-3">
                      <p class="name">Mark Lee Hong Hao</p>
                      <span class="position">Accounting Fresh Graduate</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="item">
              <div class="testimony-wrap py-4">
                <div class="text">
                  <p class="mb-4">The site is really useful as it helped me find homes which are within my budget</p>
                  <div class="d-flex align-items-center">
                    <div class="user-img" style="background-image: url(images/t-1.jpeg)"></div>
                    <div class="pl-3">
                      <p class="name">Zain Ahmed</p>
                      <span class="position">University Malaya</span>
                    </div>
                  </div>
                </div>
              </div>
