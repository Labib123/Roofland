      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center"> <!--slider text for animation-->
          <div class="col-md-9 ftco-animate pb-5 text-center">
            ...
            <h1 class="mb-3 bread" style="color:black;">About Us</h1>
          </div>
        </div>
      </div>
    </section>
		...
		<section class="ftco-section ftco-no-pb">
			<div class="container">
	          ...
	          <div class="heading-section p-md-5">
	            <h2 class="mb-4">Centered around convenience.</h2>
              <p>Hailing from Maldives, Jun needed to find a suitable accommodation at reasonable budget during her University days. Upon looking for homes from all sorts of site, she realised none of them really fit her budget and even if it did, it wasn't convenient for her </p>
	            <p> That is when Jun got the idea of starting an accomodation site that is centered around convenience and afforadability. With RoofLand, people all of age can find the home they are looking for. </p>
	          </div>
					</div>
				</div>
			</div>
